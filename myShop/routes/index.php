...
match ($action) {
    ...
    'admin-list-comment' => (new CommentController)->index(),
    'admin-detail-comment' => (new CommentController)->detailComment(),
    ...
    'client-comment-product' => (new HomeController)->commentProduct(),
};

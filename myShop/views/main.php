...
<body>
    ...
    <nav class="navbar navbar-expand-md bg-light justify-content-between px-5">
        <div class="d-flex items-center">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-uppercase" href="<?= BASE_URL ?>"><b>MyShop</b></a>
                </li>
            </ul>
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-uppercase" href="<?= BASE_URL ?>?action=client-products">SẢN PHẨM</a>
                </li>
            </ul>
        </div>
        <div>
            ...
            <?php else: ?>
                <a href="<?= BASE_URL ?>?action=login" class="btn btn-info">Đăng nhập</a>
            <?php endif; ?>
        </div>
    </nav>
